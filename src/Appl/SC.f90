...
!----------------------------------------------------------------
      ...
      contains
        ...
        subroutine maplinear_SC(t,tau,xm,this,refpt,Bchg,Bmass)
        implicit none
        include 'mpif.h'
        ...
        call getaxfldE_SC(t,this,ein,e1in,e2in)
        ...
        call rk6i_SC(h,mpstp,t0,y,18,this,Bchg,Bmass)
        ...
        sqf3=sqrt(uf)**3
        tfin = t + tau
        call getaxfldE_SC(tfin,this,ef,e1f,e2f)
        ...
        end subroutine maplinear_SC

        subroutine rk6i_SC(h,ns,t,y,nvar,this,Bchg,Bmass)
        implicit none
        include 'mpif.h'
        ...
        tint=t
        do i=1,ns
          call intfunc1_SC(t,y,f,this,Bchg,Bmass)
          a=h*f
          yt=y+a/9.d0
          tt=t+h/9.d0
          call intfunc1_SC(tt,yt,f,this,Bchg,Bmass)
          b=h*f
          yt=y + (a + 3.d0*b)/24.d0
          tt=t+h/6.d0
          call intfunc1_SC(tt,yt,f,this,Bchg,Bmass)
        ...
        end subroutine rk6i_SC

        subroutine intfunc1_SC(t,y,f,this,Bchg,Bmass)
        implicit none
        include 'mpif.h'
        ...
        zedge = this%Param(1)
        call getaxfldE_SC(t,this,ez1,ezp1,ezpp1)
        ww = this%Param(3)/Scfreq 
        theta0 = this%Param(4)*asin(1.0)/90
        qmcc = Bchg/Bmass
