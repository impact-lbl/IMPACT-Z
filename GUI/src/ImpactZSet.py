...
class AdvancedSetFrame(tk.Toplevel):            
    def __init__(self, master, kernel, cnf={}, **kw):
        ...
        self.box_diag       = ttk.Combobox(self.frame1,textvariable=master.FlagOutput_Z,
        ...
        self.box_bc         = ttk.Combobox(self.frame1,textvariable=master.Flagbc,
                                           values=['Trans:open,  Longi:open',
                                                   'Trans:open,  Longi:period',
                                                   'Trans-Round, Longi-open',
                                                   'Trans-Round, Longi-perod',
                                                   'Trans:Rect,  Longi-open',
        ...
        self.label_Xrad .grid(row=rowtemp,sticky='W')
        self.entry_Xrad .grid(row=rowtemp,column=1,sticky='E')
        rowtemp+=1
        self.label_Yrad    = tk.Label(self.frame1, text='Y pipe width(m):')
        self.entry_Yrad    = tk.Entry(self.frame1,textvariable=master.Yrad)
        self.label_Yrad.grid(row=rowtemp,sticky='W')
        self.entry_Yrad.grid(row=rowtemp,column=1,sticky='E')
        rowtemp+=1
        self.label_Zrad    = tk.Label(self.frame1, text='Z periodic length(m):')
        self.entry_Zrad    = tk.Entry(self.frame1,textvariable=master.ZperiodSize)
        self.label_Zrad.grid(row=rowtemp,sticky='W')
        ...
        self.frame_Nbunch.pack(side = 'top')
        rowtemp=0
        Nbunchwidth = 9*6+2
        self.label_Nbunch    = tk.Label(self.frame_Nbunch, text="# of charge state")
        self.entry_Nbunch    = tk.Entry(self.frame_Nbunch,textvariable=master.Nbunch,width=5)
        self.label_Nbunch.grid(row=rowtemp,sticky='W')
        self.entry_Nbunch.grid(row=rowtemp,column=1,sticky='W')
        rowtemp+=1
        self.label_Nbunch1    = tk.Label(self.frame_Nbunch, text="# of particle")
        self.entry_Nbunch1    = tk.Entry(self.frame_Nbunch,textvariable=master.NpList,width=Nbunchwidth)
        self.label_Nbunch1.grid(row=rowtemp,sticky='W')
        self.entry_Nbunch1.grid(row=rowtemp,column=1,sticky='W')
        rowtemp+=1
        self.label_Nbunch2    = tk.Label(self.frame_Nbunch, text="current")
        self.entry_Nbunch2    = tk.Entry(self.frame_Nbunch,textvariable=master.CurrentList,width=Nbunchwidth)
        self.label_Nbunch2.grid(row=rowtemp,sticky='W')
        self.entry_Nbunch2.grid(row=rowtemp,column=1,sticky='W')
        rowtemp+=1
        self.label_Nbunch3    = tk.Label(self.frame_Nbunch, text="q/m")
        self.entry_Nbunch3    = tk.Entry(self.frame_Nbunch,textvariable=master.SchargeList,width=Nbunchwidth)
